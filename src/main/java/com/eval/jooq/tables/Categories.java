...
public class Categories extends TableImpl<CategoriesRecord> {
    ...
    private static final long serialVersionUID = -1259437557;

    /**
     * The reference instance of <code>eval.categories</code>
     */
    ...
    /**
     * The column <code>eval.categories.category_id</code>.
     */
    public final TableField<CategoriesRecord, Integer> CATEGORY_ID = createField("category_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>eval.categories.cat_group</code>.
     */
    public final TableField<CategoriesRecord, String> CAT_GROUP = createField("cat_group", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>eval.categories.name</code>.
     */
    public final TableField<CategoriesRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>eval.categories.description</code>.
     */
    public final TableField<CategoriesRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * Create a <code>eval.categories</code> table reference
     */
    public Categories() {
    ...
    /**
     * Create an aliased <code>eval.categories</code> table reference
     */
